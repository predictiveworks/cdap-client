...
public class WorkflowClient {
	...
	/**
	 * Retrieve all the keys in the {@link WorkflowToken} with the specified scope
	 * for the specified workflow run.
	 *
	 * @param workflowRunId
	 *            the run id of the workflow
	 * @param scope
	 *            the specified {@link WorkflowToken.Scope}
	 * @return {@link WorkflowTokenDetail} containing all the keys in the specified
	 *         {@link WorkflowToken.Scope} for the specified workflow run
	 */
	...
	/**
	 * Retrieve the specified key from the {@link WorkflowToken} for the specified
	 * workflow run.
	 *
	 * @param workflowRunId
	 *            the run id of the workflow
	 * @param key
	 *            the specified key
	 * @return {@link WorkflowTokenDetail} containing all the values for the
	 *         specified key
	 */
	...
	/**
	 * Retrieve the {@link WorkflowToken} for the specified workflow run filtered by
	 * the specified {@link WorkflowToken.Scope} and key.
	 *
	 * @param workflowRunId
	 *            the run id of the workflow
	 * @param scope
	 *            the specified {@link WorkflowToken.Scope}. If null, it returns
	 *            keys for {@link WorkflowToken.Scope#USER}
	 * @param key
	 *            the specified key. If null, it returns all keys in the specified
	 *            {@link WorkflowToken.Scope}
	...
	public WorkflowTokenDetail getWorkflowToken(ProgramRunId workflowRunId, @Nullable WorkflowToken.Scope scope,
		...
		String path = String.format("apps/%s/workflows/%s/runs/%s/token", workflowRunId.getApplication(),
	...
	/**
	 * Retrieve all the key-value pairs in a workflow run's {@link WorkflowToken}
	 * that were set by the specified node.
	 *
	 * @param workflowRunId
	 *            the run id of the workflow
	 * @param nodeName
	 *            the name of the node
	 * @return {@link WorkflowTokenNodeDetail} containing all the key-value pairs
	 *         set by the specified node in the specified workflow run's
	 *         {@link WorkflowToken}
	 */
	...
	/**
	 * Retrieve all the key-value pairs in a workflow run's {@link WorkflowToken}
	 * that were set by the specified node in the specified
	 * {@link WorkflowToken.Scope}.
	 *
	 * @param workflowRunId
	 *            the run id of the workflow
	 ...
	 * @param scope
	 *            the specified {@link WorkflowToken.Scope}
	 * @return {@link WorkflowTokenNodeDetail} containing all the keys set by the
	 *         specified node with the specified {@link WorkflowToken.Scope}in the
	...
	/**
	 * Retrieve the specified key set by the specified node in a specified workflow
	 * run's {@link WorkflowToken}.
	 *
	 * @param workflowRunId
	 *            the run id of the workflow
	 * @param nodeName
	 ...
	 * @param key
	 *            the specified key
	 * @return {@link WorkflowTokenNodeDetail} containing the specified key set by
	 *         the specified node with the specified {@link WorkflowToken.Scope}in
	 *         the specified workflow run's {@link WorkflowToken}
	 */
	...
	/**
	 * Retrieve the keys set by the specified node in the {@link WorkflowToken} for
	 * the specified workflow run filtered by the specified
	...
	public WorkflowTokenNodeDetail getWorkflowTokenAtNode(ProgramRunId workflowRunId, String nodeName,
			...
			throws IOException, UnauthenticatedException, NotFoundException, UnauthorizedException {
		String path = String.format("apps/%s/workflows/%s/runs/%s/nodes/%s/token", workflowRunId.getApplication(),
				workflowRunId.getProgram(), workflowRunId.getRun(), nodeName);
		URL url = config.resolveNamespacedURLV3(workflowRunId.getNamespaceId(),
				appendScopeAndKeyToUrl(path, scope, key));
		HttpResponse response = restClient.execute(HttpMethod.GET, url, config.getAccessToken(),
				HttpURLConnection.HTTP_NOT_FOUND);
	 ...
	 * @throws IOException
	 *             if the error occurred during executing the http request
	 * @throws UnauthenticatedException
	 *             if the request is not authorized successfully in the gateway
	 *             server
	 * @throws NotFoundException
	 *             if the workflow with given runid not found
	 */
	public Map<String, DatasetSpecificationSummary> getWorkflowLocalDatasets(ProgramRunId workflowRunId)
		...
		return ObjectResponse.fromJsonBody(response, new TypeToken<Map<String, DatasetSpecificationSummary>>() {
			private static final long serialVersionUID = -7830294035131111829L;
		}).getResponseObject();
	}
	...
	public Map<String, WorkflowNodeStateDetail> getWorkflowNodeStates(ProgramRunId workflowRunId)
		...
		return ObjectResponse.fromJsonBody(response, new TypeToken<Map<String, WorkflowNodeStateDetail>>() {
			private static final long serialVersionUID = -3375337874294197124L;
		}).getResponseObject();
	}
}
