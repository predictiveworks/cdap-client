...
/*
 * Changed to project internal explore to reduce dependencies
 * Dr. Krusche & Partner PartG
 */
import co.cask.cdap.client.explore.ExploreClient;
import co.cask.cdap.client.explore.ExploreExecutionResult;
import co.cask.cdap.client.explore.SuppliedAddressExploreClient;
