...
import co.cask.cdap.client.common.StreamNotFoundException;
import co.cask.cdap.client.common.UnauthenticatedException;
/*
 * Changed to project internal stream to reduce dependencies
 * Dr. Krusche & Partner PartG
 */
import co.cask.cdap.client.common.stream.StreamEventTypeAdapter;
/*
 * Changed to project internal utils to reduce dependencies
 * Dr. Krusche & Partner PartG
 */
import co.cask.cdap.client.common.utils.TimeMathParser;
...
public class StreamClient {
	...
	private static final TypeToken<List<StreamDetail>> STREAM_DETAIL_LIST_TYPE = new TypeToken<List<StreamDetail>>() {
		private static final long serialVersionUID = 2508793892553881996L;
	};
